...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_plantuml_previewer#System#Job#import() abort
  ...
  execute join(['function! vital#_plantuml_previewer#System#Job#import() abort', printf("return map({'start': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:t_list = type([])
